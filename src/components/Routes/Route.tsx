...
export const Route: FunctionComponent<RouteProps> = ({
  ...
  const RouteContent = ({ _route, _toToken }: { _route: QuoteRoute; _toToken: SupportedToken }): ReactNode => {
    return (
      <>
            ...
            <div className='flex flex-row gap-1 items-center justify-center'>
              ...
              <div className='flex flex-col'>
                <p className={theme === 'light' ? 'text-black' : 'text-white' + ' font-manrope text-xl font-medium'}>
                  {toTokenReadable(_toToken.decimals, getAmount(_route))} {_toToken.symbol}
                </p>
        ...
        {/* TODO: Replace */}
        <RouteDetails gas={'$1.32'} fees={'$2.44'} time={'~2 min'} steps={0} />
      </>
    );
  };
