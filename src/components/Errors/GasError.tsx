...
export interface GasErrorProps {
    label?: string
}

const GasError: FunctionComponent<GasErrorProps> = ({label}) => {
    return (
        <div className='flex flex-row justify-center items-center bg-component-bg border-1 border-border-color rounded-lg px-2 py-2 gap-1'>
            ...
            <p className='font-manrope text-sm text-failure-red'>
                {label}
            </p>
        </div>
