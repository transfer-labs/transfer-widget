            ...
            >
                <div className='flex flex-col gap-2'>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        >
                            <input className='bg-component-background border-1 border-border-color p-2 rounded-lg w-full text-white placeholder-unselected-text font-Manrope' value={slippageValue} onChange={handleSlippageChange} type="number" step="0.01" />
                        </motion.div>
                        <motion.div
                            initial={{ opacity: 0, y: 50 }}
                            animate={{ opacity: 1, y: 0 }}
