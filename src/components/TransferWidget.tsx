...
import { DefaultIcon } from '../icons/Loading-States/Token-Network/default-token.svg'
          ...
          <div className = 'flex px-4 py-3 flex-col gap-1 w-full  border rounded-lg border-border-color bg-component-background'>
            ...
            <div className="flex flex-row w-full items-center gap-1 ">
                  ...
                  <div className="flex flex-row gap-2 items-center">
                      ...
                      <svg width="43" height="40" viewBox="0 0 64 59" fill="none" xmlns="http://www.w3.org/2000/svg">
